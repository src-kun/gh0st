...
protected: // create from serialization only
	...
	CToolBar			m_wndToolBar;	//http://baike.baidu.com/view/2962164.htm
	CImageList			m_ToolBarList;	//http://baike.baidu.com/view/1725414.htm
...
protected:
	...
	afx_msg void OnFileManager();//文件管理
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
private:
