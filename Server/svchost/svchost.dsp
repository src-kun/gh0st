...
# ADD CPP /nologo /MD /w /W0 /GX /O2 /I "../../common" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_DLL" /FR /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ../../common/zlib/zlib.lib MSVCRT.LIB SHLWAPI.LIB /nologo /subsystem:windows /map:"../../Bin/update/server.map" /machine:I386 /out:"../../Bin/update/server.dat"
